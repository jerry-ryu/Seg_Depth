...
class FreqMSELoss(nn.Module):  # freqeuncy loss
    def __init__(self):
        super().__init__()
        self.name = "FreqMSELoss"
...
class FocalFrequencyLoss(nn.Module):
    ...
    def forward(self, pred, target, matrix=None, interpolate=True,**kwargs):
